...
// The format for a VGA text buffer is given below.
// Bits (0-7) ASCII code points
...
// This is a public interface which writes to the screen when provided an input.
pub struct Writer {
...
impl Writer {
	...
	// Function to add a newline.
	fn new_line(&mut self) {
		// Starting from the second row we move each character one row up using this for loop.
		// We are excluding first row since it is getting pushed off the screen.
